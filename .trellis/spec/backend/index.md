...
Platypus is a single-package TypeScript MCP server. There is no frontend layer.
...
- [Provider Conventions](./provider-conventions.md)
...
| [AI Clients](./ai-clients.md) | AIClient interface, Gemini/OpenAI/Anthropic implementations |
